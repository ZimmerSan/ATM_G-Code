...
final public class ATM {
    ...
    static boolean processTransfer(String fromCard, String toCard, int sum) {
    ...
    static boolean phoneRecharge(int sum) {
    ...
    static boolean changePassword(String oldPwd, String newPwd1, String newPwd2) {
